test_that("use_lpsolve returns NULL when lpSolveAPI is not installed", {

  skip_if(
    requireNamespace("lpSolveAPI", quietly = TRUE),
    "The 'lpSolveAPI' package is required. Install it using install.packages('lpSolveAPI')"  )
  ...
  varname <- "x1"
  modelsense <- "max"
  params <-  list(presolve = "rows",timeout = 99999,
