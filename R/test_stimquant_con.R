...
#'
#' Let \eqn{q_s}{q_s} be the quantitative attribute value of stimulus s.
#'
...
#'
#'   \item \eqn{b_{q}}{b_{q}^{stim,m}} is the required bound for the sum of stimulus-level quantitative attribute values in module m.
#'
#'   \item \eqn{b_{q}}{b_{q}^{stim,r}} is the required bound for the sum of stimulus-level quantitative attribute values in pathway r.
#' }
#'
