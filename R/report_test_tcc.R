...
#' @description
#'
#' Computes and reports TCC curves aggregated at the
#' module or pathway level for assembled MST panels.
#'
#' Item-level category probabilities are obtained from \link{compute_icc}().
#'
#'
...
#' \describe{
#'   \item{panel_id}{Identifier of the assembled panel.}
#'   \item{module_id / pathway_id}{Identifier of the module or pathway.}
#'   \item{theta}{Ability level at which the statistics are evaluated.}
#'   \item{TCC}{Test characteristic curve value, defined as the expected total score
#'   \eqn{\sum E[P(Y = k \mid \theta)]}{sum E[P(Y = k | theta)]}.}
#'   \item{max_score}{Maximum possible score for the module or pathway.}
#'   \item{TCC_norm}{Normalized TCC value defined as \code{TCC / max_score}.}
#' }
#'
#' @seealso
#'
