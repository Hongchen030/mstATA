...
#'
#' For an enemy item set \eqn{V_e^{item}}{V_e^{item}}:If one item in the set is selected anywhere in the pathway,
...
#'
#' Let \eqn{V_e^{item}}{V_e^{item}} denotes a set of items that are mutually exclusive (enemy) items.
#'
#' \deqn{
