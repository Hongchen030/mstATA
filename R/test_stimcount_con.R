...
#'
#'   \item \eqn{n_m}{n_m} specify the required number of stimuli in module m.
#'
#'   \item \eqn{n_r}{n_r} specify the required number of stimuli in pathway r.
#' }
#'
#'
#'
...
#' Springer. \doi{10.1007/0-387-29054-0}.
#'
#' @examples
