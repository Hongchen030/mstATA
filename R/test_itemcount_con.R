...
#'
#'   \item \eqn{n_m}{n_m} specify the required number of items in module m.
#'
#'   \item \eqn{n_r}{n_r} specify the required number of items in pathway r.
#'
#'   \item \eqn{n_t^{\min}}{n_t^{\min}} specify the minimum number of items in stage t.
#'
#'   \item \eqn{n_t^{\max}}{n_t^{\max}} specify the maximum number of items in stage t.
#'
#'   \item \eqn{m}{m}, and \eqn{m'}{m'} are a pair of modules in stage t.
#' }
#'
