...
#'
#' @description
#' Creates a linear objective term of the form \eqn{a^\top x}{a^\top x}, where the vector
#' \eqn{a}{a} represents categorical or quantitative attribute values for the
#' involved items (or stimuli), and the decision variables \eqn{x}{x} represent
...
#' \itemize{
#'   \item \strong{Relative objective} - maximize or minimize \eqn{a^\top x}{a^\top x}.
#'   \item \strong{Absolute deviation objective} - minimize \eqn{|a^\top x - g|}{|a^\top x - g|} where \eqn{g}{g} is the target value.
#' }
#'
...
#'   \eqn{ |a^\top x - g| }{ |a^\top x - g| } where \eqn{g}{g} is the target value.
...
#' **2. Objective meaning**
#'
#' If `cat_level = NULL`, the vector \eqn{a}{a} consists of quantitative attribute
#' values.
#' If `cat_level` is specified, \eqn{a}{a} is an indicator vector for items in the
