...
#'   \item \strong{Target plus or minus deviation constraints:} \code{target} and \code{deviation}
#' }
#'
...
#'      \strong{(number of category levels) x (number of modules specified) x side}
#'
#'   \item \strong{Pathway-level:} when \code{which_pathway} is provided and \code{which_module = NULL}
#'
#'    The number of constraints =
#'      \strong{(number of category levels) x (number of pathways specified) x side}
#' }
#'
...
#'
#'   \item \eqn{n_c^{m,\min}}{n_c^{m,\min}} and \eqn{n_c^{m,\max}}{n_c^{m,\max}} specify the minimum and maximum
#'   required number of items from category level c in module m.
#'
#'   \item \eqn{n_c^{r,\min}}{n_c^{r,\min}} and \eqn{n_c^{r,\max}}{n_c^{r,\max}} specify the minimum and maximum
