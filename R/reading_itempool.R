...
#'   \item{discrimination}{Discrimination parameter (\eqn{a}{a}) for the 3PL model.}
#'   \item{difficulty}{Difficulty parameter (\eqn{b}{b}) for the 3PL model.}
#'   \item{guessing}{Guessing parameter (\eqn{c}{c}) for the 3PL model.}
