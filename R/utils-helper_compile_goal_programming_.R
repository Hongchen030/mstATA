...
#' decision variables.
#'
#' Each term has a target value \eqn{g_k}{g_k}. Goal programming minimizes deviations
#' between \eqn{y_k}{y_k} and \eqn{g_k}{g_k}.
...
#'   Introduces a single non-negative deviation variable \eqn{d_k \ge 0}{d_k \ge 0} per objective term such that
#'   \deqn{
#'     |a_k^\top x - g_k| \le d_k.
#'   }
#'
...
#'   \eqn{d_k^+ \ge 0}{d_k^+ \ge 0} and \eqn{d_k^- \ge 0}{d_k^- \ge 0}, with
#'   \deqn{
...
#' }
#'
#' in two-deviation mode, where \eqn{w_k}{w_k} are user-specified or default weights.
#'
