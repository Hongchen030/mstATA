...
#'
#' The decision-variable linking constraints (e.g., \link{dvlink_item_solution}())
...
#' \eqn{2 \times P}{2 \times P} where \eqn{P}{P} is the pool size, corresponding to one minimum and one maximum
#' constraint per item.
#'
#'
#' @seealso
