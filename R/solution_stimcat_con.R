...
#' Here:
#' \itemize{
#'   \item \eqn{s_{i_s^{*}}}{s(i_s*)}  indicates whether the pivot item for stimulus
...
#'
#'   \item \eqn{n_c^{stim}}{n_c^{stim}} is the required number of unique stimuli from category c
#'     across all panels.
#' }
#'
#'
