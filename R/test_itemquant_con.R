...
#'
#'   \item \eqn{b_{q}}{b_{q}^{item,m}} is the required bound for the sum of item-level quantitative attribute values in module m (minimum, maximum, or exact value).
#'
#'   \item \eqn{b_{q}}{b_{q}^{item,r}} is the required bound for the sum of item-level quantitative attribute values in pathway r (minimum, maximum, or exact value).
#' }
#'
