...
#' columns:
#' \describe{
#'   \item{\code{discrimination}}{Slope parameter (\eqn{a}{a}).}
#'   \item{\code{difficulty}}{Location parameter (\eqn{b}{b}).}
#'   \item{\code{guessing}}{Lower asymptote (\eqn{c}{c}).}
#'   \item{\code{upper}}{Upper asymptote (\eqn{d}{d}).}
#' }
#'
#' Missing parameters required for a given model are automatically filled. For example, the RASCH and 1PL
#' models are represented with \eqn{a = 1}{a = 1}, \eqn{c = 0}{c = 0}, and \eqn{d = 1}{d = 1}.
#'
...
#' \eqn{K}{K} denotes the number of non-baseline response
#' categories.
...
#' \code{deltaj1}, \dots, \code{deltajK}). See \link{Pi_internal}().
#'
