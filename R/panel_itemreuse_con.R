...
#'
#' \itemize{
#'   \item (1) If an item is selected in the routing module implies it cannot appear in any S2 or S3 module.
#'
#'   \item (2) If selected in an S2 module implies it may appear in other S2 modules (same stage),
#'         but not in S1R or any S3 module.
#'
#'   \item (3) If selected in an S3 module implies it may appear in other S3 modules,
