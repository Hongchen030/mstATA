...
#'
#'   \item \eqn{n_c^{m}}{n_c^{m}} specify the required number of items from category level c in module m.
#'
#'   \item \eqn{n_c^{r}}{n_c^{r}} specify the required number of items from category level c in pathway r.
#' }
#'
