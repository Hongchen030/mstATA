...
#'
#' For an enemy stimulus set \eqn{V_e^{stim}}{V_e^{stim}}:If a stimulus in the set is selected anywhere in the pathway,
...
#'
#' Let \eqn{V_e^{stim}}{V_e^{stim}} denotes a set of stimuli that are mutually exclusive (enemy).
#'
#' \deqn{
