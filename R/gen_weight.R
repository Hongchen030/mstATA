...
#' Supports:
#' \itemize{
#'   \item Named base-R distributions via their densities (e.g., \code{norm}, \code{t}, \code{logis}, \code{unif}, \code{beta},
#'   \code{gamma}, \code{lnorm},...).
...
#' \describe{
#'   \item{theta}{The supplied ability grid.}
#'   \item{w}{Normalized weights, \code{sum(w) = 1}.}
#' }
#'
#' @examples
