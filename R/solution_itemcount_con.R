...
#'
#'
#' For each item \eqn{i_s}{i_s}, \eqn{s_{i_s}}{s_{i_s} = 1} if item \eqn{i_s}{i_s} is used in any module in any panel.
...
#' Here:
#' \itemize{
#'   \item \eqn{s_{i_s}}{s_{i_s}} is the binary decision variable indicating whether
#'   item \eqn{i_s}{i_s} is used at least once across all panels.
#'
#'   \item \eqn{\substack{\leq \\ \geq \\ =}}{\substack{\leq \\ \geq \\ =}} denotes that the specification may take the form of an
#'   upper bound, lower bound, or exact value.
#'
#'   \item \eqn{n^{item}}{n^{item}} is the user-specified minimum, exact, or maximum number of unique items.
#' }
#'
#'
#'
