...
#' theta, which does not necessarily have to be 1.
#'
...
#'   Each element corresponds to a theta point. Names must match
#'   the column names of \code{cdist_by_prev}.
#'
...
#'
#' @details
#' Let \eqn{S_{prev}}{S_{prev}} denote the cumulative score prior to the current stage,
#' and \eqn{S_{next}}{S_{next}} the score from the next-stage module.
